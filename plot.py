...
# 1. 读取两个文件中的数据
with open('passwords_last.txt', 'r', encoding='utf-8') as f:
    passwords = [line.strip() for line in f]

with open('target_passwords1.txt', 'r', encoding='utf-8') as f:
